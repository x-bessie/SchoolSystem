...
public class UserController {
     ...
     */
    @Log("根据username获取Id")
    @ApiOperation("根据username获取Id")
    @GetMapping(value = "/{userName}")
//    @RequestMapping(value = "/getUserIdByName", method = RequestMethod.GET)
    public ResponseEntity<Object> getUserIdByName(@PathVariable String userName) {
        return new ResponseEntity<>(userService.getUserIdByName(userName), HttpStatus.OK);
    }
